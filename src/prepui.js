...
function stepText(t) {
  if (t === 'scalpello') return tr('Scalpello: gratta la roccia scura', 'Chisel: scrape the dark rock');
  if (t === 'spatola') return tr('Spatola: pulisci piano', 'Spatula: clean gently');
