...
export const TIPS = {
  ...
  dna: () => [tr('DNA e chimere', 'DNA and chimeras'), tr('Completa una teca del Museo (5 pezzi della stessa specie) e ottieni una <b>fialetta di DNA</b>. Al Laboratorio ne servono <b>2</b> per risvegliare la specie. Le chimere non nascono da ossa: allevi DUE creature che hai già.', 'Complete a Museum case (5 pieces of one species) to get a <b>DNA vial</b>. The Laboratory needs <b>2</b> to awaken the species. Chimeras don\'t come from bones: you breed TWO creatures you already have.')],
