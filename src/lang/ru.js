...
export const RU = {
  ...
  'Stop the marker in the golden zone to boost your luck': 'Остановите курсор в золотой зоне, чтобы повысить удачу',
  'Luck boosted!!': 'Удача повышена!!',
  'No extra luck this time': 'В этот раз без удачи',
