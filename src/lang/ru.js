...
export const RU = {
  ...
  'Quest complete: you caught the fireflies!': 'Задание выполнено: ты поймал светлячков!',
  'The fireflies guide you: a map to a legendary fossil! ': 'Светлячки ведут тебя: карта к легендарной окаменелости! ',
  'map ': 'карта ',
  ...
  'Pick up ': 'Взять ',
  'in hand: walk and {act} to place it': 'в руке: иди и нажми {act}, чтобы поставить',
  ...
  'Pick a piece from your tray to place here. Wall pieces hang when you stand against the back wall.': 'Выбери предмет из лотка, чтобы поставить его здесь. Картины вешаются, если стоять у дальней стены.',
  ...
  'Tray empty: buy one at the Shop, Furniture tab.': 'Лоток пуст: купи что-нибудь в Магазине, вкладка «Мебель».',
  'Place here': 'Поставить здесь',
