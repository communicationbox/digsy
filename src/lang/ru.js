...
export const RU = {
  ...
  "Nobody yet. Get a friend's code and add it below: from then on you see them when they play, and you can invite them.": 'Пока никого. Возьми код друга и добавь его ниже: с этого момента ты видишь, когда он играет, и можешь его позвать.',
  'playing now': 'сейчас играет',
  'away': 'нет на месте',
  'Invite': 'Позвать',
  'Add a friend': 'Добавить друга',
  'their code': 'его код',
  'what you call them': 'как ты его зовёшь',
  'Add': 'Добавить',
  'Your code': 'Твой код',
  'Copy code': 'Скопировать код',
  'Give it to whoever you like: they use it to add you, and from then on you invite each other by name.': 'Дай его кому хочешь: по нему тебя добавят, а дальше зовёте друг друга по имени.',
  'Invite sent to ': 'Приглашение отправлено: ',
  'Code copied': 'Код скопирован',
  'invites you to their world': 'зовёт тебя в свой мир',
  'Not now': 'Не сейчас',
  "can't right now": 'сейчас не может',
  'Noted down': 'Записано',
