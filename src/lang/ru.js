...
export const RU = {
  ...
  'Give it to whoever you want to invite: whoever has your code enters your world.': 'Дай его тем, кого хочешь позвать: у кого есть твой код, тот войдёт в твой мир.',
  'Open my world': 'Открыть мой мир',
  'Nobody yet. Get a code from a friend and note it down here.': 'Пока никого. Возьми код у друга и запиши его сюда.',
  'Go to them': 'Пойти к нему',
  'Remove': 'Убрать',
  "a friend's code": 'код друга',
  'what you call them': 'как ты его зовёшь',
  'Add to friends': 'Добавить в друзья',
  'Join with a code': 'Войти по коду',
  "The host is whoever's code you use: you play in their world, on their clock.": 'Хозяин — тот, чей код используете: играете в его мире и по его часам.',
