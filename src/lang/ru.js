...
export const RU = {
  ...
  'To play together: ONE of you opens their world, the OTHER joins with their code.': 'Чтобы играть вместе: ОДИН открывает свой мир, ВТОРОЙ входит по его коду.',
  '1 · Open yours, and invite': '1 · Открой свой и позови',
  'Then give them this code: whoever has it comes to you.': 'Потом дай ему этот код: у кого он есть, тот придёт к тебе.',
  '2 · Or go to them': '2 · Или иди к нему',
  "your friend's code": 'код друга',
  'Join their world': 'Войти в его мир',
  ...
  'what you call them (to note them down)': 'как ты его зовёшь (чтобы записать)',
