...
export const RU = {
  ...
  'Wishing fountain': 'Фонтан желаний',
  'Tap to stop the marker on the golden zone': 'Коснитесь, чтобы остановить курсор на золотой зоне',
  'Fountain: stop the marker on the golden zone': 'Фонтан: остановите курсор на золотой зоне',
  'Deep night — go outdoors and walk among the fireflies': 'Глубокая ночь — выйдите наружу к светлячкам',
  'Dawn': 'Рассвет',
  'Fireflies': 'Светлячки',
