...
export const RU = {
  ...
  'First toss': 'Первый бросок',
  'Second toss': 'Второй бросок',
  'Last toss': 'Последний бросок',
  'Land the toss in the golden ripple': 'Останови бросок в золотом отблеске',
  'In the gold!': 'В золото!',
  'Three in a row — the fountain rewards you!': 'Три из трёх — фонтан награждает тебя!',
  'So close! Let\'s see what comes…': 'Так близко! Посмотрим, что выйдет…',
  'Out! Maybe next time': 'Мимо! В другой раз',
  ...
  'Left encrusted': 'Оставлено в корке',
  'Brush': 'Щётка',
  'Fine tool': 'Стека',
  'Cleaned': 'Очистка',
  'Intact': 'Целостность',
