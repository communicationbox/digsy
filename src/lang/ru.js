...
export const RU = {
  ...
  'Drag it where you want, then let go': 'Перетащи куда хочешь и отпусти',
  'Move the pointer and click to place it ({act} at your feet)': 'Двигай указателем и щёлкни, чтобы поставить ({act} — под ноги)',
