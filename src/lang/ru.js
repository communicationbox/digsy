...
export const RU = {
  ...
  'Stop the marker on the golden zone: the more you center it, the more luck': 'Остановите курсор на золотой зоне: чем точнее в центр, тем больше удачи',
  'Bullseye!': 'В точку!',
  'On target': 'Попал',
  'Missed: no boost': 'Мимо: без бонуса',
  'luck': 'удача',
