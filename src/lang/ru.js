...
export const RU = {
  ...
  'the online one': 'сетевой',
  'the local one': 'локальный',
  'jumps': 'скачков',
  "It's YOUR world: the others are playing here at your place.": 'Это ТВОЙ мир: остальные играют у тебя.',
  "You're in the world of whoever opened this room.": 'Ты в мире того, кто открыл эту комнату.',
  'The host sent you away.': 'Хозяин тебя выгнал.',
  'The host left: the room is closed.': 'Хозяин вышел: комната закрыта.',
  ...
  '1 · Open yours, and invite': '1 · Открой свой и позови',
  "If they haven't opened yet, you wait there: when they do, you're already in.": 'Если он ещё не открыл — подождёшь там: как откроет, ты уже внутри.',
  "To play together: ONE of you opens their world and sends the link, the OTHER opens it.": 'Чтобы играть вместе: ОДИН открывает свой мир и шлёт ссылку, ВТОРОЙ её открывает.',
  "Copy the invite link": 'Скопировать ссылку-приглашение',
  'Send it to…': 'Отправить…',
  "Whoever opens your link comes straight into your world. If you'd rather read it out, your code is:": 'Кто откроет твою ссылку, попадёт прямо в твой мир. Если хочешь продиктовать — вот твой код:',
  '2 · Or go to a friend': '2 · Или иди к другу',
  'paste their link (or their code)': 'вставь его ссылку (или код)',
  'Note ': 'Записать ',
  ' down': ' в книжку',
  'this world': 'этот мир',
  'Noted down': 'Записано',
  'Go to their world': 'Войти в его мир',
  'Link copied: send it to whoever you like': 'Ссылка скопирована: отправь кому хочешь',
  'Come dig with me!': 'Пойдём копать вместе!',
  'Open my world': 'Открыть мой мир',
  'Go to them': 'Пойти к нему',
  'Remove': 'Убрать',
  "That's not a code": 'Это не код',
  'Scenes: ': 'Сцены: ',
  'Dream': 'Сон',
  'Friends': 'Друзья',
