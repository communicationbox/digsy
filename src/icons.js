...
export const ICON_NAMES = ["arD", "arDL", "arDR", "arL", "arR", "arU", "arUL", "arUR", "bag", "barber", "bed", "bolt", "bone", "book", "bread", "bug", "cal", "coin", "compass", "dna", "dune", "flower", "frog", "globe", "hat", "home", "horn", "ice", "lab", "leaf", "map", "menu", "moon", "mount", "museum", "note", "palette", "paw", "pick", "pine", "rib", "save", "shirt", "skull", "snow", "sparkle", "spiral", "sprout", "store", "sun", "wheat"];


/* colore tematico per icona (fill=currentColor eredita da style) */
const ICOL = {
  coin: '#e8b93c', bolt: '#f2c53d', cal: '#c65a54', compass: '#c65a54', bag: '#8a5f38', bug: '#c65a54',
...
const EMAP = {
  ...
  '💫': 'sparkle', '✨': 'sparkle', '🎨': 'palette', '🤠': 'hat', '📖': 'book', '🗺️': 'map', '🧬': 'dna',
...
export function hydrateIcons() {
  document.querySelectorAll('#hud .tag, .db, #abtn').forEach(el => { el.innerHTML = withIcons(el.innerHTML); });
}
